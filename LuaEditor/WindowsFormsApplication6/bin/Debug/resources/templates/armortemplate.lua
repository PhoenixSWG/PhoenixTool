...
-- template *
object_tangible_wearables_armor_newarmorfolder_armor_newarmorname_armorslot =  object_tangible_wearables_armor_newarmorfolder_shared_armor_newarmorname_armorslot:new {

	-- Don't Change Me
	templateType = ARMOROBJECT,

	-- Used to add Color Picker Radial. Uncomment out to add in.
	--objectMenuComponent = {"cpp", "ArmorObjectMenuComponent"},	

	-- "Imperial" or "Rebel"
	faction = "Imperial",

-- Add in playable character races that can wear this
-- or add in vendors that can wear this
